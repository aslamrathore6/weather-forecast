package com.kepler.weather.forecast;
...
import com.kepler.weather.forecast.Adapter.WeatherForecastAdapter;
import com.kepler.weather.forecast.Model.WeatherForecastResult;
import com.kepler.weather.forecast.Retrofit.IOpenWeatherMap;
import com.kepler.weather.forecast.Retrofit.RetrofitClient;
...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler_forecast.hasFixedSize();
    ...
    private void getForecastWeatherInformation() {
        compositeDisposable.add(mService.getForecaseWeatherByLatLng(
...
//        Log.d("txt_city_name", weatherForecastResult.city.coord.toString());
